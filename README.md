...
- Managed product data via a centralized JS data file — no backend needed
- Integrated into Google StudyPods as a collaborative demo tool for peers
- Solved manual, error-prone spreadsheet tracking causing inventory mismatches
...
- Built collision detection, player controls, and dynamic arena elements
- Leveraged AI tools to accelerate game logic design and 3D rendering
- Used AI-assisted workflow to prototype faster while keeping code clean
...
- Built with CSS Flexbox & Grid for a clean, responsive layout
- Optimized assets for faster load times across Chrome, Firefox, and Edge
